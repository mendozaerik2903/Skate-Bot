...
If Defense fails to replicate the trick, Defense receives a letter and Offense sets a new trick.

If Offense fails to land a trick, a turnover occurs and roles switch.
...
These tricks will randomly be selected through the dice roll.`,
  ...
  difficulties: {
    ...
    hard: "Advanced tricks such as tre flips, inward heelflips, and hardflips.",
  },
};
